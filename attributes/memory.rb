...
if node['elasticsearch']['auto_java_memory']
  ...
  default['logstash']['sysconfig']['LS_HEAP_SIZE'] = java_memory.to_s + 'm'
else
  # https://www.elastic.co/guide/en/elasticsearch/guide/current/heap-sizing.html
  half_memory = total_memory / 2
  half_memory += 1 unless half_memory.even?
  if half_memory >= 32_768
    default['logstash']['sysconfig']['LS_HEAP_SIZE'] = '32g'
  else
    default['logstash']['sysconfig']['LS_HEAP_SIZE'] = half_memory.to_s + 'm'
  end
end
